...
class _MainPageState extends State<MainPage> {
  ...
  void NavToAdd(BuildContext context) async {
    Items item = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => AddPage(items: items)),
    );
    setState(() {
      items.add(item);
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Container(
        decoration: BoxDecoration(
          border: Border.all(
              color: const Color.fromRGBO(255, 224, 130, 1), width: 2),
          borderRadius: BorderRadius.circular(17.0),
        ),
        child: FloatingActionButton(
          backgroundColor: const Color.fromARGB(255, 255, 238, 187),
          hoverColor: const Color.fromARGB(255, 255, 238, 187),
